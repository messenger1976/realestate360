        ...
        <div class="agent-container" id="panel">
            ...
            <div class="agent-holder clearfix">
                ...
                <div class="detail">
                    ...
                    <div class="agent-properties"><a href="<?php echo site_url('show/agentproperties/'.$user->id);?>" style="color:#fff;"><?php echo get_user_properties_count($user->id);?> <?php echo lang_key('DBC_PROPERTIES');?></a></div>
