<div class="detail-title"><i class="fa fa-user"></i>&nbsp;Choose a package</div>
<div class="row">
    <div class="col-md-12">
        <?php 
                    ...
                    <div class="thumbnail thumb-shadow">
                        ...
                        <div class="caption">
                            ...
                            <div style="clear:both;">
                                <span style="float:left; font-weight:bold;"><?php echo lang_key('DBC_PRICE'); ?>:</span>
                                <span style="float:right; "><?php echo $package->price;?> $</span>
                            </div>
                            <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>
                            <div style="clear:both;">
                                <span style="float:left; font-weight:bold;"><?php echo lang_key('DBC_LIMIT'); ?>:</span>
                                <span style="float:right; "><?php echo $package->expiration_time;?> Days</span>
                            </div>
                            <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>
                            <div style="clear:both;">
                                <span style="float:left; font-weight:bold;"><?php echo lang_key('DBC_USAGE'); ?>:</span>
