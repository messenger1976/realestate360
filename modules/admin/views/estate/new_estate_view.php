...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-title">
        <h3><i class="fa fa-bars"></i>Basic information</h3>
        <div class="box-tool">
      ...
      <div class="box-content">
                ...
                <div class="tab-content" id="myTabContent1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4 col-lg-5 controls">
                        <input type="text" name="title<?php echo $lang->short_name;?>" value="<?php echo(set_value('title'.$lang->short_name)!='')?set_value('title'.$lang->short_name):'';?>" placeholder="Package Title" class="form-control input-sm" >
          ...
          <div class="form-group">
              <label class="col-sm-3 col-lg-2 control-label">Purpose :</label>
              <div class="col-sm-4 col-lg-5 controls">
          ...
          <div class="form-group">
              <label id="sales-label" class="col-sm-3 col-lg-2 control-label">Sales Price:</label>
              <div class="col-sm-4 col-lg-5 controls">
                  <div class="input-group">
                      <span class="input-group-addon"><?php echo get_settings('site_settings','default_currency','$');?></span>
                      <input type="text" id="total_price" name="total_price" value="<?php echo(set_value('total_price')!='')?set_value('total_price'):'';?>" placeholder="Total Price" class="form-control input-sm" >
                  </div>
                  <span class="help-inline">&nbsp;</span>
          ...
          <div class="form-group">
              <label class="col-sm-3 col-lg-2 control-label">Price per Unit:</label>
              <div class="col-sm-4 col-lg-3 controls">
                  <div class="input-group">
                      <span class="input-group-addon">$</span>
                      <input type="text" id="price_per_unit" name="price_per_unit" value="<?php echo(set_value('price_per_unit')!='')?set_value('price_per_unit'):'';?>" placeholder="Price Per Unit" class="form-control input-sm" >
                  </div>
                  <span class="help-inline">&nbsp;</span>
            ...
            <div id="rent-price-holder" class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Rent Price:</label>
                <div class="col-sm-4 col-lg-3 controls">
                    <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" id="rent_price" name="rent_price" value="<?php echo(set_value('rent_price')!='')?set_value('rent_price'):'';?>" placeholder="Rent Price" class="form-control input-sm" >
                    </div>
                    <span class="help-inline">&nbsp;</span>
            ...
            <div id="home-size-holder" class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Home Size:</label>
                <div class="col-sm-4 col-lg-3 controls">
                        <input type="text" id="home_size" name="home_size" value="<?php echo(set_value('home_size')!='')?set_value('home_size'):'';?>" placeholder="Home Size" class="form-control input-sm" >
                    <span class="help-inline">&nbsp;</span>
            ...
            <div id="lot-size-holder" class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Lot Size:</label>
                <div class="col-sm-4 col-lg-3 controls">
                        <input type="text" id="lot_size" name="lot_size" value="<?php echo(set_value('lot_size')!='')?set_value('lot_size'):'';?>" placeholder="Lot Size" class="form-control input-sm" >
                        <span class="help-inline">&nbsp;</span>
            ...
            <div id="bedroom-holder" class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Bedrooms:</label>
                <div class="col-sm-4 col-lg-5 controls">
                    <input type="text" id="bedroom" name="bedroom" value="<?php echo(set_value('bedroom')!='')?set_value('bedroom'):'';?>" placeholder="Bedrooms" class="form-control input-sm" >
                    <span class="help-inline">&nbsp;</span>
            ...
            <div id="bath-holder" class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Baths:</label>
                <div class="col-sm-4 col-lg-5 controls">
                    <input type="text" id="bath" name="bath" value="<?php echo(set_value('bath')!='')?set_value('bath'):'';?>" placeholder="Bath" class="form-control input-sm" >
                    <span class="help-inline">&nbsp;</span>
            ...
            <div id="year-built-holder" class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Year Built:</label>
                <div class="col-sm-4 col-lg-5 controls">
                    <input type="text" id="year_built" name="year_built" value="<?php echo(set_value('year_built')!='')?set_value('year_built'):'';?>" placeholder="Year Built" class="form-control input-sm" >
                    <span class="help-inline">&nbsp;</span>
            ...
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Current status :</label>
                <div class="col-sm-4 col-lg-5 controls">
            ...
            <?php if(is_admin()){ ?>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Agent :</label>
                <div class="col-sm-4 col-lg-5 controls">
                    <?php $CI = get_instance();
    ...
    <div class="box">
      ...
      <div class="box-title">
        <h3><i class="fa fa-bars"></i>General Amenities</h3>
        <div class="box-tool">
          <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
        </div>
      </div>
                ...
                <div class="box-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 col-lg-8 controls">
                            <input type="text" id="address" name="address" value="<?php echo(set_value('address')!='')?set_value('address'):'';?>" placeholder="Address" class="form-control input-sm" >
                            <span class="help-inline">&nbsp;</span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 col-lg-8 controls">
                            ...
                            <input type="text" id="state" name="state" value="<?php echo(set_value('state')!='')?set_value('state'):'';?>" placeholder="State/Province" class="form-control input-sm" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 col-lg-8 controls">
                            ...
                            <input type="text" id="city" name="city" value="<?php echo(set_value('city')!='')?set_value('city'):'';?>" placeholder="City/Town" class="form-control input-sm" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 col-lg-8 controls">
                            <input type="text" name="zip_code" value="<?php echo(set_value('zip_code')!='')?set_value('zip_code'):'';?>" placeholder="Zip Code" class="form-control input-sm" >
                            <span class="help-inline">&nbsp;</span>
    ...
    <div class="box">
      ...
      <div class="box-title">
       ...
       <div class="box-content">
            ...
            <h4><?php echo lang_key('DBC_EMBED_VIDEO_URL');?> :</h4>
           <div class="alert alert-danger">First create property. Then you'll be able to add youtube or vimeo url from edit option</div> 
            <h4>Gallery :</h4>
           <div class="alert alert-danger">First create property. Then you'll be able to upload gallery photos from edit option</div> 
