...
<head>
    ...
    <title>Realestate360 | Admin Panel</title>
    ...
    <div class="login-wrapper">
      ...
      <form id="form-login" action="<?php echo site_url('admin/auth/login/');?>" method="post">
          ...
          <div class="login-form-title">
              <h4><i class="fa fa-lock"></i> Realestate360 Admin</h4>
           </div>
           
            <div style="text-align:center">
                <img src="<?php echo base_url('assets/images/phpscriptsonline-logo-new.png');?>" style="height:60px; margin:20px 0px 0px;" />
            </div>
